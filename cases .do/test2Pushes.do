...
# push R1
mem load -filltype value -filldata 1110010000001000 -fillradix binary /processor/fetchObj/instMem/RAM(768)    

# push R2 
mem load -filltype value -filldata 1110010000010000 -fillradix binary /processor/fetchObj/instMem/RAM(769)  

# pop R1
mem load -filltype value -filldata 1110101001000000 -fillradix binary /processor/fetchObj/instMem/RAM(770)    

# pop R2
mem load -filltype value -filldata 1110101010000000 -fillradix binary /processor/fetchObj/instMem/RAM(771)    
